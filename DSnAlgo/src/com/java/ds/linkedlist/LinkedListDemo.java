...
public class LinkedListDemo {
	...
	public static void main(String args[]) {
		...
		list.addAtEnd("Salsburg");
		list.addAtEnd("Munich");
		list.addAtEnd("Vienna");
		System.out.println("Adding an element to the linked list");
		// displayValues(list);
		// list.display();
		// list.insert("Salsburg","Venice");
		reverseList(list);
		list.display();
	}

	public static void displayValues(LinkedList list) {
	...
	/*
	 * list.addAtEnd("Milan"); list.addAtEnd("Venice"); list.addAtEnd("Salsburg");list.addAtEnd("Munich"); list.addAtEnd("Vienna");
	 */
